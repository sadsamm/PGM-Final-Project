...
mlp.compile(optimizer='adam', loss=bayesian_loss)
mlp.fit(train_predictions_mean, y_train, epochs=number_of_epochs, batch_size=32)
...
for epoch in range(number_of_epochs):
    history = mlp.fit(train_predictions_mean, y_train, epochs=1, batch_size=32, validation_data=(test_predictions_mean, y_test))
    train_loss_mlp.append(history.history['loss'][0])
    test_loss_mlp.append(history.history['val_loss'][0])

# Get predictions from the MLP
train_predictions = mlp.predict(train_predictions_mean)
test_predictions = mlp.predict(test_predictions_mean)
